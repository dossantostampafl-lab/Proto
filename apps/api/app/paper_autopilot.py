...
class PaperAutopilotService:
    ...
    async def _cycle(self) -> None:
        ...
        # Re-check the authoritative live-health contract immediately before a
        # simulated submission. This closes the race between the initial cycle
        # read and a feed disconnect/staleness transition during decision work.
        if not self._live_market_ready(config.symbol):
